job('ModelBusExplorer-DiffMerge-Git-2.0') {
    ...
    steps {
		...
		rootPOM("${WORKSPACE}/ModelBusExplorer/trunk/org.modelbus.tools.modelbusexplorer.build.master/pom.xml")
        }
    ...
    publishers {
		...
		artifacts("${WORKSPACE}/ModelBusExplorer/trunk/org.modelbus.tools.modelbusexplorer.build.category/target/*zip")
		failsAsUpload(true)
